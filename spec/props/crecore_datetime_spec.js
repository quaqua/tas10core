...
vows.describe('CreioDateTime').addBatch({

  "a date object stays a date object new(new Date())": function(){
    var d = new Date();
    var value = CreioDateTime.new( d );
